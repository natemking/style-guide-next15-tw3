...
/**
 * Compatibly configurations
 * Create FlatCompat instance to handle shared configs not up to date with the latest eslint flat config
 * https://eslint.org/docs/latest/use/configure/migration-guide#using-eslintrc-configs-in-flat-config
 */
const compat = new FlatCompat({ baseDirectory: import.meta.dirname });
const compatCommentsPluginRecommended = compat.config(commentsPlugin.configs.recommended);
const compatNextPluginRecommended = compat.config(nextPlugin.configs.recommended);
